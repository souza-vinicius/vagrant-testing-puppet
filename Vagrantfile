...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "puppetmaster" do |pm|
    ...
    pm.vm.provision "shell", inline: "sudo ln -s /opt/VBoxGuestAdditions-4.3.10/lib/VBoxGuestAdditions /usr/lib/VBoxGuestAdditions"
  ...
  config.vm.define "puppet-agent-ubuntu" do |pau|
    ...
    # pau.vm.provision "shell", inline: "sudo dpkg -i http://apt.puppetlabs.com/puppetlabs-release-pc1-xenial.deb"
    pau.vm.provision "shell", inline: "sudo apt-get update | apt-get install puppet -y"
